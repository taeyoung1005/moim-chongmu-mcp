...
function availabilityVoteGrid(board: AvailabilityBoard, selected: ReadonlySet<string>): string {
  ...
  return [
    `<div class="vote-hint">셀을 누른 채로 드래그해서 가능한 시간을 빠르게 칠하세요.</div>`,
...
function styles(): string {
  return `:root{color-scheme:light;--bg:#f7f8f5;--panel:#ffffff;--panel-soft:#fbfcfa;--ink:#17201c;--muted:#66746c;--line:#dfe6df;--accent:#13795b;--accent-strong:#0d5d46;--accent-soft:#eef5ef;--ok:#e8f6ef;--bad:#fff0ee;--bad-text:#a33a2d;--neutral:#eef2ee;--on-accent:#ffffff;--heat-0:#f5f7f4;--heat-1:#dbeee4;--heat-2:#add8bf;--heat-3:#62b985;--heat-4:#13795b;--content-max:1040px;--control-height:44px;--submit-height:48px;--time-column-width:62px;--date-column-width:86px;--matrix-cell-height:42px;--vote-cell-width:84px;--vote-cell-height:46px;--space-0:0;--space-1:4px;--space-1-5:6px;--space-2:8px;--space-2-5:10px;--space-3:12px;--space-3-5:14px;--space-4:16px;--space-4-5:18px;--space-5:20px;--space-8:32px;--space-9:36px;--space-12:48px;--radius-control:6px;--radius-panel:8px;--text-eyebrow:12px;--text-label:13px;--text-day:15px;--text-body:16px;--text-h1:32px;--text-h1-mobile:26px;--line-heading:1.2;--weight-bold:700;--weight-heavy:800;--motion-fast:120ms}*{box-sizing:border-box}html{width:100%;max-width:100%;overflow-x:hidden}body{width:100%;max-width:100%;overflow-x:hidden;margin:var(--space-0);background:var(--bg);color:var(--ink);font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}main{width:min(100% - var(--space-8),var(--content-max));margin:var(--space-0) auto;padding:var(--space-8) var(--space-0) var(--space-12)}.header{padding:var(--space-2) var(--space-0) var(--space-5)}.eyebrow{margin:var(--space-0) var(--space-0) var(--space-2);color:var(--accent);font-size:var(--text-eyebrow);font-weight:var(--weight-bold)}.header h1{margin:var(--space-0);font-size:var(--text-h1);line-height:var(--line-heading)}.header p,.muted{color:var(--muted)}.panel{background:var(--panel);border:1px solid var(--line);border-radius:var(--radius-panel);padding:var(--space-5);margin-top:var(--space-4)}.compact{padding:var(--space-4)}.field,.note{display:grid;gap:var(--space-2);margin-bottom:var(--space-4)}.field span,.note span{font-size:var(--text-label);font-weight:var(--weight-bold);color:var(--muted)}.hint{margin:calc(-1 * var(--space-2)) var(--space-0) var(--space-4);color:var(--muted);font-size:var(--text-label)}select,input{width:100%;min-height:var(--control-height);border:1px solid var(--line);border-radius:var(--radius-control);padding:var(--space-0) var(--space-3);font:inherit}.vote-hint{margin:var(--space-0) var(--space-0) var(--space-2);color:var(--muted);font-size:var(--text-label)}.vote-scroll{width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;contain:layout paint;border:1px solid var(--line);border-radius:var(--radius-panel);background:var(--panel);touch-action:pan-x}.availability-vote-grid{display:grid;grid-template-columns:var(--time-column-width) repeat(var(--vote-date-count),var(--vote-cell-width));width:max-content;min-width:100%;isolation:isolate;user-select:none}.vote-corner,.vote-date,.vote-time,.vote-cell{border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.vote-corner,.vote-time{position:sticky;left:0;z-index:2;background:var(--panel);color:var(--muted);font-size:12px;font-weight:var(--weight-bold)}.vote-corner{display:grid;place-items:center;min-height:54px}.vote-date{display:grid;align-content:center;gap:2px;min-height:54px;padding:var(--space-2);text-align:center;background:var(--panel-soft)}.vote-date strong{font-size:14px}.vote-date span{font-size:11px;color:var(--muted)}.vote-time{display:grid;place-items:center;min-height:var(--vote-cell-height)}.vote-cell{display:grid;place-items:center;min-height:var(--vote-cell-height);background:var(--heat-0);color:transparent;cursor:pointer;touch-action:none;transition:background-color var(--motion-fast) ease-out,box-shadow var(--motion-fast) ease-out}.vote-cell:hover{background:var(--accent-soft)}.vote-cell.selected{background:var(--accent);box-shadow:inset 0 0 0 1px var(--accent-strong)}.vote-cell.selected::after{content:"";width:10px;height:10px;border-radius:50%;background:var(--on-accent)}.vote-cell.empty{cursor:default;background:repeating-linear-gradient(-45deg,var(--panel-soft),var(--panel-soft) 6px,var(--neutral) 6px,var(--neutral) 7px)}.vote-cell input{position:absolute;width:1px;min-height:1px;opacity:0;pointer-events:none}.vote-cell span{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%)}.availability-vote-grid.is-dragging .slot{cursor:cell}.submit{width:100%;min-height:var(--submit-height);margin-top:var(--space-4-5);border:0;border-radius:var(--radius-control);background:var(--accent);color:var(--on-accent);font:inherit;font-weight:var(--weight-heavy);transition:background-color var(--motion-fast) ease-out}.submit:hover{background:var(--accent-strong)}.alert{margin:var(--space-0);padding:var(--space-3) var(--space-3-5);border-radius:var(--radius-panel);background:var(--neutral);color:var(--muted)}.success{background:var(--ok);color:var(--accent-strong)}.error{background:var(--bad);color:var(--bad-text)}.result-panel{overflow:hidden}.result-head{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:var(--space-2);margin:var(--space-3) var(--space-0) var(--space-4)}.best-chip{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:var(--space-2);min-height:44px;padding:var(--space-2) var(--space-3);border:1px solid var(--line);border-radius:var(--radius-control);background:var(--panel-soft)}.best-chip span{display:grid;place-items:center;width:22px;height:22px;border-radius:50%;background:var(--accent);color:var(--on-accent);font-size:12px;font-weight:var(--weight-heavy)}.best-chip strong{font-size:13px;line-height:1.25}.best-chip em{font-style:normal;font-weight:var(--weight-heavy);color:var(--accent-strong)}.availability-matrix{contain:layout paint;display:grid;grid-template-columns:var(--time-column-width) repeat(var(--date-count),var(--date-column-width));align-items:stretch;width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;border:1px solid var(--line);border-radius:var(--radius-panel);background:var(--panel);isolation:isolate}.matrix-corner,.matrix-date,.matrix-time,.matrix-cell{border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.matrix-corner,.matrix-time{position:sticky;left:0;z-index:2;background:var(--panel);font-size:12px;font-weight:var(--weight-bold);color:var(--muted)}.matrix-corner{display:grid;place-items:center;min-height:54px}.matrix-date{display:grid;align-content:center;gap:2px;min-height:54px;padding:var(--space-2);text-align:center;background:var(--panel-soft)}.matrix-date strong{font-size:14px}.matrix-date span{font-size:11px;color:var(--muted)}.matrix-time{display:grid;place-items:center;min-height:var(--matrix-cell-height)}.matrix-cell{display:flex;align-items:center;justify-content:center;min-height:var(--matrix-cell-height);font-size:13px;background:var(--heat-0);color:var(--muted)}.matrix-cell strong{font-size:15px;color:var(--ink)}.matrix-cell.level-1{background:var(--heat-1)}.matrix-cell.level-2{background:var(--heat-2)}.matrix-cell.level-3{background:var(--heat-3);color:var(--on-accent)}.matrix-cell.level-4{background:var(--heat-4);color:var(--on-accent)}.matrix-cell.level-3 strong,.matrix-cell.level-4 strong{color:var(--on-accent)}.matrix-cell.empty{background:repeating-linear-gradient(-45deg,var(--panel-soft),var(--panel-soft) 6px,var(--neutral) 6px,var(--neutral) 7px)}.legend{display:flex;align-items:center;justify-content:flex-start;gap:var(--space-1-5);margin-top:var(--space-3);color:var(--muted);font-size:12px}.legend-swatch{width:18px;height:12px;border:1px solid var(--line);border-radius:3px}.legend-swatch.level-1{background:var(--heat-1)}.legend-swatch.level-2{background:var(--heat-2)}.legend-swatch.level-3{background:var(--heat-3)}.legend-swatch.level-4{background:var(--heat-4)}@media (max-width:720px){main{width:min(100% - var(--space-5),var(--content-max));padding:var(--space-5) var(--space-0) var(--space-9)}.header h1{font-size:var(--text-h1-mobile)}.panel{padding:var(--space-3-5)}.result-head{grid-template-columns:1fr}.vote-scroll,.availability-matrix{width:calc(100% + var(--space-3-5) * 2);max-width:none;margin-inline:calc(-1 * var(--space-3-5));border-left:0;border-right:0;border-radius:0}.legend{justify-content:flex-start}}`
}
